...
<stylenode LOCALIZED_TEXT="defaultstyle.note" ID="ID_1327065955" COLOR="#000000" BACKGROUND_COLOR="#ffffcc" TEXT_ALIGN="LEFT">
...
<node TEXT="README.md" STYLE_REF="MarkdownHelperNode" POSITION="right" ID="ID_1638680456" LINK="file:/C:/Users/Edo/Documents/GitHub/freeplane-devtools/previous%20versions/README.md">
...
<node TEXT="freeplane-devtools (previous versions)" ID="ID_878825798">
<node TEXT="Here are the add-on versions that I merged and used to build on them." ID="ID_1858887915"/>
<node TEXT="devtools-v0.9.27.addon.mm" ID="ID_1043466359">
<node TEXT="text block" STYLE_REF="MarkdownHelperNode" ID="ID_988044995"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<html>
  ...
  <body>
    <p>
      This version was released by **$1**&nbsp;&nbsp;( **$2** : $3, $4 ) and is related to bug report $5 .
    </p>
    <p>
...
<node TEXT="sourceforge" ID="ID_423414882" LINK="https://sourceforge.net/u/haaihenkie/profile/"/>
</node>
<node TEXT="web link" STYLE_REF="MarkdownHelperNode" ID="ID_892037771"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<node TEXT="web link" STYLE_REF="MarkdownHelperNode" ID="ID_1302696017"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<node TEXT="about this version" ID="ID_1156155159"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
  ...
  <body>
    <p>
      This version was released by **$1**&nbsp;&nbsp;( **$2** : $3, $4, $5 )
    </p>
    <p>
      
    </p>
    <p>
      Its source code is located in its $6 .
    </p>
    <p>
...
<node TEXT="github" ID="ID_630299163" LINK="https://github.com/gpapp"/>
</node>
<node TEXT="web link" STYLE_REF="MarkdownHelperNode" ID="ID_905111888"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<node TEXT="sourceforge" ID="ID_1363402570" LINK="https://sourceforge.net/u/gergelypapp/profile/"/>
</node>
<node TEXT="web link" STYLE_REF="MarkdownHelperNode" ID="ID_230146255"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<node TEXT="https://www.itworks.hu/" ID="ID_863994267" LINK="https://www.itworks.hu/"/>
</node>
<node TEXT="web link" STYLE_REF="MarkdownHelperNode" ID="ID_1321120261"><richcontent TYPE="NOTE" CONTENT-TYPE="xml/">
<html>
  <head>
...
<node TEXT="Github repository" ID="ID_1782551669" LINK="https://github.com/gpapp/freeplane-devtools"/>
</node>
...
<node TEXT="This version adds support to property files for i18n." ID="ID_1528683840"/>
</node>
</node>
</node>
<node TEXT="**IMPORTANT**:  &#xa;This map needs that the **MarkdownHelper** add-on is installed to work properly." LOCALIZED_STYLE_REF="styles.important" POSITION="left" ID="ID_1577494057" ICON_SIZE="96 pt" BACKGROUND_COLOR="#ffff00" STYLE="rectangle" SHAPE_HORIZONTAL_MARGIN="10 pt" SHAPE_VERTICAL_MARGIN="10 pt" FORMAT="markdownPatternFormat" BORDER_WIDTH="3 px" MAX_WIDTH="13 cm">
